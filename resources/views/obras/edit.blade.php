...
<div class="container">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Editar obra</li>
        </ol>
    </nav>
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header font-weight-bold"><i class="fa fa-fw fa-edit"></i>Editar obra</div>

                <div class="card-body">
                    <p class="card-title">Campos com <span class="text-danger">*</span> são obrigatórios!</p>
                    <form method="POST" action="{{ route('obras.update',['obra'=>$obra]) }}">
                        @method('patch')
                        @csrf
                            ...
                            <div class="col-md-6">
                                <select id="tipo_material" data-live-search="true" data-actions-box="true"
                                    ...
                                    <option value="{{$tipo->id}}"
                                        {{ (old("tipo_material",$obra->tipo_material) == $tipo->id ? "selected":"") }}>
                            ...
                            <div class="col-md-6">
                                <select id="categoria" data-live-search="true" data-actions-box="true"
                                    ...
                                    <option value="{{$categoria->id}}"
                                        {{ (old("categoria",$obra->categoria) == $categoria->id ? "selected":"") }}>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="titulo" type="text"
                                    ...
                                    @error('titulo') autofocus @enderror value="{{ old('titulo',$obra->titulo) }}"
                                    required>
                            ...
                            <div class="col-md-6">
                                ...
                                <select id="autores" data-live-search="true" multiple data-actions-box="true"
                                    ...
                                    <option value="{{$autor->id}}"
                                        {{ (in_array($autor->id, old("autores",$obra->autores()->pluck('id')->toArray())) ? "selected":"") }}>
                            ...
                            <div class="col-md-6">
                                <select id="assuntos" multiple data-live-search="true" data-actions-box="true"
                                    ...
                                    <option value="{{$assunto->id}}" @error('assuntos') autofocus @enderror
                                        {{ (in_array($assunto->id, old("assuntos",$obra->assuntos()->pluck('id')->toArray())) ? "selected":"") }}>
                            ...
                            <div class="col-md-6">
                                <select id="editora" data-live-search="true" data-actions-box="true" @error('editora')
                                    ...
                                    <option value="{{$editora->id}}"
                                        {{ (old("editora",$obra->editora) == $editora->id ? "selected":"") }}>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea id="observacao" type="text" @error('observacao') autofocus @enderror
                                    ...
                                    name="observacao">{{ old('observacao',$obra->observacao) }}</textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="localizacao" type="text"
                                    ...
                                    value="{{ old('localizacao',$obra->localizacao) }}" placeholder="99.99.99 AA AA"
                                    @error('localizacao') autofocus @enderror required>
