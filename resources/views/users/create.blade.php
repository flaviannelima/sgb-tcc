...
<div class="container">
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header font-weight-bold"><i class="fa fa-fw fa-plus-circle"></i>Cadastrar usuário</div>
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('users.store') }}">
                        ...
                        <div class="form-group row">
                            <label for="password" class="col-md-4 col-form-label text-md-right">Senha<span
                                    class="text-danger">*</span></label>
                        ...
                        <div class="form-group row">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-right">Confirmação de senha<span
                                    class="text-danger">*</span></label>
