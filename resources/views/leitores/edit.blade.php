...
<div class="container">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Editar leitor</li>
        </ol>
    </nav>
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header font-weight-bold"><i class="fa fa-fw fa-plus-circle"></i>Editar leitor
                </div>

                <div class="card-body">
                    <p class="card-title">Campos com <span class="text-danger">*</span> são obrigatórios!</p>
                    <form method="POST" action="{{ route('leitores.update',['leitor' => $leitor]) }}">
                        @csrf
                        @method('patch')
                        <input type="hidden" name="user" value="{{ $leitor->user()->first()->id }}">
                        <div class="form-group row">
                            <label for="nome" class="col-md-4 col-form-label text-md-right">Nome:</label>

                            <div class="col-md-6">
                                <input type="text" name="nome" id="nome" disabled
                                    value="{{$leitor->user()->first()->name}}" class="form-control">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="text" name="email" id="email" disabled
                                    value="{{$leitor->user()->first()->email}}" class="form-control">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="text" name="cpf" id="cpf" required placeholder="999.999.999-99"
                                    value="{{old('cpf',$leitor->cpf)}}" class="form-control @error('cpf') is-invalid  
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="date" name="data_nascimento" id="data_nascimento" required
                                    value="{{old('data_nascimento',$leitor->data_nascimento->format('Y-m-d'))}}" class="form-control @error('data_nascimento') is-invalid  
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="text" name="endereco" id="endereco" required
                                    value="{{old('endereco',$leitor->endereco)}}" class="form-control @error('endereco') is-invalid  
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="text" name="telefone_residencial" id="telefone_residencial" placeholder="(99) 9999-9999"
                                    value="{{old('telefone_residencial',$leitor->telefone_residencial)}}" class="form-control @error('telefone_residencial') is-invalid  
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="text" name="celular" id="celular" required placeholder="(99) 99999-9999"
                                    value="{{old('celular',$leitor->celular)}}" class="form-control @error('celular') is-invalid  
